let projectsData = [
    ...
    },
    {
        ...
        difficulties: "This was my 3rd project on the Bootcamp, it was a group project and I think the hardest part for me was having to do all the frontend by myself, while also helping with the backend. We only had a week to finish and this was a big project with several small details to it, but we prevailed.",
        technologies:
    ...
    },
    {
        ...
        difficulties: "This was my 2nd Bootcamp project and definitely my favorite. My biggest challenge was to figure out how to implement the live search bar, so as you type it reloads live. I ended up creating a regex of input query and searching the games with that regex.",
        technologies:
    ...
    },
    {
        ...
        difficulties: "I created this game to practice what I have learned in class. It was really fun to create this game and I think the biggest challenge for me was to make the go button to disappear, the count to appear and then the count disappear and the winner appear. I ended up using setTimeout and a few variables that I would check what 'state' should I be showing at the moment",
        technologies: "HTML, CSS, JavaScript, and GitHub Pages."
    },
    {
        name: "Tic-Tac-Toe",
        ...
        difficulties: "I created this game to practice what I have learned in class. My greatest challenge was learning how to deal with box-shadow in CSS to make it neon like.",
        technologies: "HTML, CSS, JavaScript, and GitHub Pages."
    }
];
